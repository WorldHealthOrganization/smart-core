...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/occupation']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/occupation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/consenttocontact']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/consenttocontact': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/educationlevel']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/educationlevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/estimatedage']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/estimatedage': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/insurance']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/insurance': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:communication">
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/reminder']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/reminder': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
