...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/requestertype']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/requestertype': maximum cardinality of 'extension' is 1</sch:assert>
